...
def _line(item, quantity, unit_price, discount='0.00', tax_rate='0.00'):
    return {
        'item': item,
...
def test_create_invoice_calculates_totals_with_tax_and_discount(chart_of_accounts):
    ...
    invoice = create_invoice(
        ...
        due_date='2026-07-15',
        lines=[_line(item, '2', '100.00', discount='20.00', tax_rate='10.00')],
    )
...
def test_create_invoice_sums_multiple_lines(chart_of_accounts):
    ...
    invoice = create_invoice(
        ...
        due_date='2026-07-15',
        lines=[
            _line(item_a, '1', '50.00'),
            _line(item_b, '3', '10.00', tax_rate='10.00'),
        ],
    )
...
def test_create_invoice_skips_journal_entry_when_total_is_zero(chart_of_accounts):
    ...
    invoice = create_invoice(
        ...
        issue_date='2026-07-01',
        due_date='2026-07-15',
        lines=[_line(item, '1', '100.00', discount='100.00')],
    )
